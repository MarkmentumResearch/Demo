...
<ul>
  ...
  <li><b>Rankings</b> – Category dashboards (e.g., Sectors & Styles, Indices, Currencies, Rates) with a current snapshot of Markmentum Scores. The page opens with a category heatmap (average current score by category). 
