...
<ul>
  ...
  Displays probable ranges, risk/reward bias, and Markmentum Scores for key macro exposure (Indices, S&P 500 sectors, Gold, USD, TLT, BTC Futures), plus top 5 gainers/laggards by % change and by Markmentum Score, and an optional category snapshot for deeper drill-downs. 
