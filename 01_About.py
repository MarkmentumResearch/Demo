...
<h3>Methodology</h3>
<ul>
  <li><b>Probable Ranges</b> – Derived from historical distributions of intraday highs and lows, realized volatility, and liquidity-aware smoothing across daily/weekly/monthly horizons.</li>
  <li><b>Anchors</b> – Anchors – Derived anchor levels extrapolated by aligning short-term trend structure with long-term trend structure, providing a probabilistic reference to measure extension and mean-reversion risk.</li>
