...
- **Rvol 30Day Z-Score Rank**: Measures recent volatility to its historical baseline. 
...
_ADVICE_RE = re.compile(r"\b(cover|allocate|should|stop[- ]?loss|take profit)\b", re.I)
...
def collect_deepdive_context(ticker: str, as_of: str, stat_row) -> dict:
    ...
    if month_rr > 0:
        month_risk_reward = "Postive - More reward than risk within the monthly band."
    elif month_rr < 0:
