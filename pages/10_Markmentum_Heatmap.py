...
c_blank,left_toggle, c_sel, c_lock = st.columns([0.1,0.30, 0.45, 0.15])
with left_toggle:
...
st.caption(f"Color scale fixed globally to ±{vmax_global:g}. Values outside this range are shown at the end color.")
