...
with col_card:
    ...
    st.markdown(
        ...
        <div class="card-wrap">
          <div class="card">
            <h3 style="margin:0 0 -20x 0; font-size:20px; font-weight:700; color:#1a1a1a; text-align:center;">
              Category Averages
            </h3>
            <div style="text-align:center; font-size:16px; color:#666; margin:-20px 0 12px;">
