...
.tbl col.col-name { min-width:20ch; width:20ch; max-width:20ch; }
...
.tbl col.col-small { width:15ch; min-width:15ch; max-width:15ch; }
...
st.markdown('<div id="hm-center"></div>', unsafe_allow_html=True)
c_blank, col_card, c_blank = st.columns([1,.85,1])
with col_card:
    tf_order = ["Daily", "WTD", "MTD", "QTD"]
