...
<meta charset="utf-8">
<style>
  /* ===== Signal Pack: stat-box style, fixed grid, shrink-to-content ===== */

  /* place the card in the same Streamlit column as the Stat Box */
  .sp-wrapper {{ display: inline-block; width: auto; }}
  ...
  .sp-title {{margin: 0 0 6px 0; font-size: 14px; font-weight: 700; color: #1a1a1a; white-space: nowrap;}}

  /* each section is its own table (like the Stat Box) */
  table.sp {{
    border-collapse: collapse;
    table-layout: fixed;             /* enforce fixed widths via <colgroup> */
    border: 1px solid #D7D9E0;
    margin: 0;
    width: auto;                     /* prevent full-width stretch */
  }}
  table.sp + table.sp {{ margin-top: 8px; }}   /* space between sections */
  ...
  /* left-most label cell (like Stat Box row headers) */
  td.rowlabel {{
    background: #F6F7FB;
    color: #3c435a;
    font-weight: 600;
  ...
  /* mini header row per section (v2-style subhead) */
  tr.subhead th {{
    background: #F6F7FB;
    color: #3c435a;
    font-weight: 600;
  ...
  /* Quadrant: single line, plain text (no shading) */
