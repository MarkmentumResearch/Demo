...
col_left, col_center, _ = st.columns([3.8, 2.1, 0.01], gap="small")
...
"""
        st_html(html_doc, height=360, scrolling=False)
...
with col_center:
    ...
    if g1.empty:
        ...
        fig, ax = plt.subplots(figsize=(7, 6), constrained_layout=True)  # was ~9.5 x 5.8
